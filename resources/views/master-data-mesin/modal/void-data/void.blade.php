<div class="modal fade bd-example-modal-lg modalMesin" tabindex="-1" id="modalMesin" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-bottom text-white">
                <h4 class="modal-title"><i class="fa-brands fa-pix"></i> Form Masterdata Mesin --Void--</h4>
            </div>
            <div class="row">
                <div class="col">
...
<script>
    $(document).on('click', '.voided', function(e) {
        ...
        // $('.modal-title').html('Master data Mesin (VOID)')
    ...
    function voidedData(master) {
        ...
        $('.modal-footer').off('click', '.void_submit').on('click', '.void_submit', function() {
            var route = "{{ route('void_master_data', ':id') }}";
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#masterdata_mesin-datatables').DataTable().ajax.reload();
                    // });
                    // $('#not_void').val("");
                    // $('#modalMesin').modal('hide
                },
