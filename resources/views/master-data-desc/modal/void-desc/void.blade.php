<div class="modal fade bd-example-modal-lg modalDesc" tabindex="-1" id="modalDesc" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-bottom text-white">
                <h4 class="modal-title"><i class="fa-brands fa-pix"></i> Form Masterdata Desc --Void--</h4>
            </div>
            <div class="row">
                <div class="col">
...
<script>
    $(document).on('click', '.voided', function(e) {
        ...
        // $('.modal-title').html('Master Data Desc (VOID)')
    ...
    function voidedData(master) {
        ...
        $('.modal-footer').off('click', '.void_submit').on('click', '.void_submit', function() {
            var route = "{{ route('void_master_desc', ':id') }}";
