<div class="modal fade bd-example-modal-lg modalVoidmaster" tabindex="-1" id="ModalVoidmaster" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-bottom text-white">
                <h4 class="modal-title"><i class="fa-brands fa-pix"></i> Form Masterdata PointSheet --Void--</h4>
            </div>
            <div class="row">
                <div class="col">
...
<script>
    ...
    function voidedData(master) {
        ...
        $('.modal-footer').off('click', '.void_submit').on('click', '.void_submit', function() {
            var route = "{{ route('void_master_point', ':id') }}";
