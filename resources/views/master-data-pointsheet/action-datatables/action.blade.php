<div style="text-align: center; ">
    <div class="btn-group">
        ...
        <div class="dropdown-menu">
            <a href="#" style="color: rgb(88, 152, 248);" data-toggle="tooltip" row-id="{{ $model->id_point }}"
                data-id="{{ $model->id_mesin }}" data-placement="top" title="Edit" class="dropdown-item edit">
                <i class="fa fa-pen-to-square"></i> Edit</a>
            <a href="#" style="color: red;" data-toggle="tooltip" row-id="{{ $model->id_point }}"
