<div class="modal fade bd-example-modal-lg modalVoidImage" tabindex="-1" id="modalVoidImage" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-bottom text-white">
                <h4 class="modal-title"><i class="fa-brands fa-pix"></i> Form Masterdata Image --Void--</h4>
            </div>
            <div class="row">
                <div class="col">
                    <div class="modal-body">
                        <form id="form-master-void" method="post" action="javascript:void(0)">
                            ...
                            <div class="form-group row">
                                <label for="number" class="col-2 col-form-label">Name Mesin</label>
                                <div class="col-9">
...
<script>
    $(document).on('click', '.voided', function(e) {
        ...
        // $('.modal-title').html('Master Data Image (VOID)')
        $('.master_void').val(master);
        $('#modalVoidImage').modal('show');
        $('#not_void').focus();
        voidedData(master);
    ...
    function voidedData(master) {
        ...
        $('.modal-footer').off('click', '.void_submit').on('click', '.void_submit', function() {
            var route = "{{ route('void_master_data_image', ':id') }}";
