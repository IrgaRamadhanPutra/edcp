    ...
    <div class="btn-group">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item view" href="#" style="color: rgb(15, 128, 143);" data-toggle="tooltip"
                row-id="{{ $model->id_pic }}" data-placement="top" title="View"><i class="fa fa-eye"></i> View</a>

            <a href="#" style="color: rgb(88, 152, 248);" data-toggle="tooltip" row-id="{{ $model->id_pic }}"
                data-id="{{ $model->name }}" data-placement="top" title="Edit" class="dropdown-item edit">
                <i class="fa fa-pen-to-square"></i> Edit</a>

            <a href="#" style="color: red;" data-toggle="tooltip" row-id="{{ $model->id_pic }}"
                data-id={{ $model->name }} data-target="" data-placement="top" title="Void"
